...
def visualizeEncoderDecoder(img, img_, z, z_,index):
    """
...
def visualizeAnomalyImage(img, img_, z, z_):
    ...
    plt.imshow(s_map[:, :, 0], cmap = plt.cm.cividis, alpha = 0.4, interpolation='nearest')
    # file_name = str(index) + '.png'
    # sava_path = os.path.join('/home/gwc/桌面/2d', file_name)
