...
def parse_args(phase = 'train'):
    ...
    parser.add_argument('--resume'          , type = str, default = '/data/gewenchao/anomaly_2D/RES_xin/result6_120_20.pkl')
    parser.add_argument('--det'             , type = str, default = '/data/gewenchao/anomaly_2D/RES_xin/result6_120_20.pkl')
